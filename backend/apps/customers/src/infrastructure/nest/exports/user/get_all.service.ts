...
import { GetAllUserResponse } from '@gameficato/customers/interface/controllers/user/get_all.controller';
import { GetAllUserNatsRequest } from '@gameficato/customers/infrastructure/nest/controllers/user/get_all.controller';
